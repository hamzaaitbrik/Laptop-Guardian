...
Now that you installed the repository and the modules it depends on. You can begin setting it up by running ```setup.py``` using the command ```python3 setup.py``` into a Terminal or CMD window opened in the directory that contains the repository.